 ...
 * Size: 110 px
 * Bpp: 4
 * Opts: --size 110 --bpp 4 --format lvgl --font assets/fonts/liberation-sans/LiberationSans-Bold.ttf --symbols 0123456789: --no-kerning --no-compress --lv-font-name clock_time_110 -o WaveshareHodiny/ClockTimeFont110.c
 ******************************************************************************/
