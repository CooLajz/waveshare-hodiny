 ...
 * Size: 24 px
 * Bpp: 4
 * Opts: --size 24 --bpp 4 --format lvgl --font /private/tmp/waveshare-lvfont/node_modules/@fontsource/montserrat/files/montserrat-latin-500-normal.woff -r 0x20-0x7E,0xB0,0xB2,0xB3,0xB5 --no-compress --lv-font-name clock_unit_24 -o WaveshareHodiny/ClockUnitFont24.c
 ******************************************************************************/
...
#ifndef CLOCK_UNIT_24
#define CLOCK_UNIT_24 1
#endif
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 9506, .adv_w = 165, .box_w = 10, .box_h = 10, .ofs_x = 0, .ofs_y = 8},
    {.bitmap_index = 9556, .adv_w = 262, .box_w = 13, .box_h = 18, .ofs_x = 2, .ofs_y = -5}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t clock_unit_24 = {
#else
lv_font_t clock_unit_24 = {
#endif
